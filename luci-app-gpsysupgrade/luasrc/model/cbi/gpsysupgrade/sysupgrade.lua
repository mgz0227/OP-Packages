...
function to_check()
    ...
    if board_name == "x86_64" then
    	...
    	if fs.access("/sys/firmware/efi") then
    		download_url = "https://op.miaogongzi.cc/23.05/targets/x86/64/" ..model.. "/" ..remote_version.. "-openwrt-x86-64-generic-squashfs-combined-efi.img.gz"
    	else
    		download_url = "https://op.miaogongzi.cc/23.05/targets/x86/64/" ..model.. "/" ..remote_version.. "-openwrt-x86-64-generic-squashfs-combined.img.gz"
    		md5 = ""
    	end
    elseif board_name == "x86_generic" then
    	...
    	check_update()
    	if fs.access("/sys/firmware/efi") then
    		download_url = "https://op.miaogongzi.cc/23.05/targets/x86/64/" ..model.. "/" ..remote_version.. "-openwrt-x86-generic-squashfs-combined-efi.img.gz"
    	else
    		download_url = "https://op.miaogongzi.cc/23.05/targets/x86/64/" ..model.. "/" ..remote_version.. "-openwrt-x86-generic-squashfs-combined.img.gz"
    		md5 = ""
    	end
    elseif board_name:match("phicomm,k3$") or board_name:match("rt%-ac88u$") then
		check_update()
		download_url = "https://op.miaogongzi.cc/23.05/targets/x86/64/" ..model.. "/" ..remote_version.. "-openwrt-" ..target.. "-" ..board_name.. "-squashfs.trx"
    elseif target:match("sunxi") then
		check_update()
		download_url = "https://op.miaogongzi.cc/23.05/targets/x86/64/" ..model.. "/" ..remote_version.. "-openwrt-" ..target.. "-" ..board_name.. "-squashfs-sdcard.img.gz"    
    elseif arch:match("aarch64_generic") or board_name:match("rpi%-") then
		check_update()
		download_url = "https://op.miaogongzi.cc/23.05/targets/x86/64/" ..model.. "/" ..remote_version.. "-openwrt-" ..target.. "-" ..board_name.. "-squashfs-sysupgrade.img.gz"
    else
		check_update()
		download_url = "https://op.miaogongzi.cc/23.05/targets/x86/64/" ..model.. "/" ..remote_version.. "-openwrt-" ..target.. "-" ..board_name.. "-squashfs-sysupgrade.bin"
    end
